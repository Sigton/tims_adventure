...
scenes = {
    ...
    "old_man": [
        ...
        ("The three wizard guardians of the land tried to stop the monster, but its negativity was too strong for even the wizard's magical power.", 1),
...
power and built gates between the sections of the land.""", 1),
        ...
        ("These villagers will become corrupted. Their minds cast into darkness, and they will join the ranks of the jelly monsters army.", 1),
